#ifndef SOFA_HIGHORDERTOPOLOGY_GENERATEBEZIERCYLINDER_INL
#define SOFA_HIGHORDERTOPOLOGY_GENERATEBEZIERCYLINDER_INL

#include "GenerateBezierCylinder.h"
...
GenerateBezierCylinder<DataTypes>::GenerateBezierCylinder()
...
template <class DataTypes>
void GenerateBezierCylinder<DataTypes>::init()
{
    addInput(&f_radius);
    addInput(&f_height);
    addInput(&f_origin);
...
template <class DataTypes>
void GenerateBezierCylinder<DataTypes>::reinit()
{
    update();
}
